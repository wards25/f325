		...
		<tr>
			<td class="tbl-border-td2" colspan="2">
				...
				<select class="select-withBorder select-company" onchange="LoadList();">
					<option value="">All</option>
					<?php
					$vendor_query = mysqli_query($conn,"SELECT * FROM dbcompany WHERE active='1'");
				...
				<select class="select-withBorder select-cluster" onchange="LoadList();">
					<option value="">All</option>
					<?php
					$cluster_query = mysqli_query($conn,"SELECT * FROM dbcensus GROUP BY cluster ORDER BY cluster ASC ");
				...
				<table class="tbl-form-detail">
					<tr>
						<td class="tbl-form-detail-td1" colspan="4">
							<button type="button" class="button-withBorder button-form-menu button-print" onclick="PrintFile();">Re-Print</button>
						...
						<td class="tbl-form-detail-td2" colspan="4">
							<table class="tbl-vendor-detail">
								...
								<tr>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-pageno" disabled="disabled">
									</td>
								</tr>
								<tr>
							...
							<table class="tbl-reference">
								...
								<tr>
									...
									<td class="tbl-reference-td1">
										<input type="text" class="input-withBorder input-status" process="" value="" disabled="disabled">
									</td>
								</tr>
							</table>
						</td>
							...
							<div class="div-scroll">
								<table class="tbl-order-detail">
									<tr>
										...
										<th class="tbl-order-detail-th10">Status</th>
									</tr>
