...
{	
	...
	<tr>
		...
		<td class="tbl-order-detail-td6">
			<input type="text" class="input-NoBorder input-unitcost" costextend="<?php echo ($fetch_stock['quantity']*$fetch_stock['unitcost']); ?>" value="<?php echo number_format($fetch_stock['quantity']*$fetch_stock['unitcost'],2); ?>" disabled="disabled">
		</td>
	</tr>
	<?php
}
