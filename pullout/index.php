...
<body>
				...
				<table class="tbl-form-detail">
					<tr>
						<td class="tbl-form-detail-td1" colspan="4">
							...
							<button type="button" class="button-withBorder button-form-menu button-pullout" disabled="disabled">Pull-Out</button>
							<button type="button" class="button-withBorder button-form-menu button-disposed" disabled="disabled">Disposed</button>
							...
							{
								?>
								<button type="button" class="button-withBorder button-form-menu button-reopen">Authorize Cancel</button>
								<?php
							}
							?>
						...
						<td class="tbl-form-detail-td2" colspan="4">
							<table class="tbl-vendor-detail">
								<tr>
									...
									<th class="tbl-vendor-detail-th1 input-fileupload">Doc. File:</th>
									<td class="tbl-vendor-detail-td1 input-fileupload">
										<input type="file" class="input-withBorder input-logpfile input-fileupload" accept=".jpg,.jpeg,.png">
										<button type="button" class="button-withBorder button-view-f325-doc">View Doc. File</button>
									</td>
								</tr>
								<tr>
						...
						<td class="tbl-form-detail-td3" colspan="4">
							<div class="div-scroll div-scroll-sku">
								<table class="tbl-order-detail">
									<tr>
										<th class="tbl-order-detail-th1">Branch Name</th>
										<th class="tbl-order-detail-th2">F325 Number</th>
										<th class="tbl-order-detail-th3">Description</th>
										<th class="tbl-order-detail-th4">Quantity</th>
										<th class="tbl-order-detail-th5">UoM</th>
										<th class="tbl-order-detail-th6">Cost Extended</th>
									</tr>
	...
	<!-- submit confirmation -->
	<div class="div-confirm div-confirm-pullout">
		<div class="div-confirm-border">
			<h4 class="h4-header">Are you sure? This is for pull-out?</h4>
			<button type="button" class="button-confirm-style" onclick="ForPullOut();">Yes</button>
			<button type="button" class="button-confirm-style" onclick="$('.div-confirm').hide();">No</button>
		</div>
	</div>

	<!-- submit confirmation disposed -->
	<div class="div-confirm div-confirm-disposed">
		<div class="div-confirm-border">
			<h4 class="h4-header">Are you sure? This is for disposed?</h4>
			<button type="button" class="button-confirm-style" onclick="ForDisposed();">Yes</button>
			<button type="button" class="button-confirm-style" onclick="$('.div-confirm').hide();">No</button>
		</div>
	</div>
