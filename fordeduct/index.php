		...
		<tr>
			<td class="tbl-border-td2" colspan="2">
				...
				<select class="select-withBorder select-status" onchange="LoadList();">
					...
					<option value="OKFORDEDUCT">OK for Deduct</option>
				</select>
				...
				<table class="tbl-form-detail">
					<tr>
						<td class="tbl-form-detail-td1" colspan="4">
							...
							<button class="button-withBorder button-form-menu button-okforbill">OK for Bill</button>
						...
						<td class="tbl-form-detail-td2" colspan="4">
							<table class="tbl-vendor-detail">
								<tr>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-arnumber" disabled="">
									</td>
								</tr>
								<tr>
									...
									<th class="tbl-vendor-detail-th1">Page #:</th>
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-pageno" required="required">
									</td>
								</tr>
								<tr>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-location" disabled="disabled">
									</td>
									<th class="tbl-vendor-detail-th1 file-upload">Doc. Upload:</th>
							...
							<div class="div-scroll div-scroll-raw">
								<table class="tbl-order-detail">
									<tr>
										...
										<th class="tbl-order-detail-th4">BBD</th>
										<th class="tbl-order-detail-th5">DMPI Reason</th>
										<th class="tbl-order-detail-th6">R. Code</th>
										<th class="tbl-order-detail-th7">Quantity</th>
										<th class="tbl-order-detail-th8">Unit Cost</th>
										<th class="tbl-order-detail-th9">Cost Ext.</th>
									</tr>
