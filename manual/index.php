...
<body>
	<table class="tbl-border">
		...
		<tr>
			<td class="tbl-border-td2" colspan="2">
				<button type="button" class="button-withBorder input-newf325">Create F325</button>
				...
				<input type="text" class="input-withBorder input-search" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" onkeyup="LoadList();" placeholder="Branch Code..." value="">
	...
	<div class="div-bg">
		<div class="div-form">
			<form class="form-order-detail" onsubmit="">
				<table class="tbl-form-detail">
					<tr>
						<td class="tbl-form-detail-td1" colspan="4">
							<button type="button" class="button-withBorder button-form-menu button-reopen">Re-Open</button>
							<button class="button-withBorder button-form-menu button-save">Save</button>
							<button type="button" class="button-withBorder button-form-menu button-cancelled">Cancelled</button>
							...
							<button type="button" class="button-withBorder button-style-form">X Close</button>
							<input type="hidden" class="input-f325id">
						</td>
					</tr>
					<tr>
							...
							<table class="tbl-vendor-detail">
								<tr>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-customer" placeholder="Branch Code..." code="" deducttype="" onclick="$(this).select();" required="required">
										<div class="div-branch-scroll">
											<table class="tbl-branch">
												<tbody class="tbody-list-branch"></tbody>
											</table>
										</div>
									</td>
									<th class="tbl-vendor-detail-th1">TM #:</th>
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-tmnumber" placeholder="Truck Manifest">
									</td>
									<th class="tbl-vendor-detail-th1">Company:</th>
									<td class="tbl-vendor-detail-td1">
										<select class="select-withBorder input-company" vcode="" required="required">
											<option value="0"></option>
											<?php
											$company_query = mysqli_query($conn,"SELECT * FROM dbcompany WHERE active='1'");
											while ($fetch_company = mysqli_fetch_array($company_query))
											{
												?>
												<option value="<?php echo $fetch_company['vendorcode']; ?>"><?php echo $fetch_company['name']; ?></option>
												<?php
											}
											?>
										</select>
								...
								<tr>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="date" class="input-withBorder input-emaildate" value="<?php echo date("Y-m-d"); ?>" required="required">
									</td>
									<th class="tbl-vendor-detail-th1">Driver Name:</th>
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-driver" placeholder="Driver Name">
									</td>
									<th class="tbl-vendor-detail-th1">Issued By:</th>
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-issued" placeholder="Issued By" required="required">
									</td>
								</tr>
								<tr>
									<th class="tbl-vendor-detail-th1">Prepared By:</th>
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-prepared" placeholder="Prepared By" required="required">
									</td>
									<th class="tbl-vendor-detail-th1">Plate #:</th>
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-platenumber" placeholder="Plate #" required="required">
									</td>
								</tr>
							</table>
							<table class="tbl-reference">
								<tr>
									...
									<td class="tbl-reference-td1">
										<input type="text" class="input-withBorder input-ordernumber" oldordernumber="" placeholder="F325 Number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" minlength="12" maxlength="12" required="required">
									</td>
								</tr>
								<tr>
									<th class="tbl-reference-th1">F325 Date</th>
									<td class="tbl-reference-td1">
										<input type="date" class="input-withBorder input-orderdate" required="required">
									</td>
								</tr>
								<tr>
									<th class=" tbl-reference-th1">Status</th>
									<td class="tbl-reference-td1">
										<input type="text" class="input-withBorder input-status" value="OPEN" disabled="disabled">
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td class="tbl-form-detail-td3" colspan="4">
							<div class="div-scroll div-scroll-raw">
								<table class="tbl-order-detail">
									<tr>
										<th class="tbl-order-detail-th10"></th>
									...
									<tbody class="tbody-order-detail-list"></tbody>
									<tr class="tbl-order-detail-tr-button">
										<td class="tbl-order-detail-button-td" colspan="3">
											<button type="button" class="button-withBorder button-addprd" disabled="disabled">Add</button>
										</td>
									</tr>
								</table>
							</div>
					...
					<tr>
						...
						<td class="tbl-vendor-detail-td4"></td>
						<td class="tbl-vendor-detail-td4 tbl-vendor-detail-remarks"></td>
							...
							<table class="tbl-subtotal">
								<tr>
									...
									<td class="tbl-subtotal-td1">
										<input type="text" class="input-withBorder input-costextended-subtotal" value="0.00" disabled="disabled">
									</td>
								</tr>
							</table>
						</td>
	...
	<div class="div-prd-scroll">
		<table class="tbl-prd">
			<tr>
				<th class="tbl-prd-th1">MDC Code</th>
				<th class="tbl-prd-th2">Description</th>
			</tr>
			<tbody class="tbody-list-prd"></tbody>
		</table>
	</div>
