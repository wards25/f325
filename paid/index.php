...
<body>
				...
				<table class="tbl-form-detail">
					<tr>
						<td class="tbl-form-detail-td1" colspan="4">
							<button type="button" class="button-withBorder button-form-menu button-paid" onclick="Deduction();">Paid</button>
						...
						<td class="tbl-form-detail-td2" colspan="4">
							<table class="tbl-vendor-detail">
								<tr>
									...
									<th class="tbl-vendor-detail-th1">APV #:</th>
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-apvnumber">
									</td>
								</tr>
								<tr>
					...
					<tr>
						...
						<td class="tbl-vendor-detail-td4 tbl-vendor-detail-remarks">
							<table class="tbl-remarks">
								<tr>
									<th class="tbl-remarks-th1">AP Remarks :</th>
									<td>
										<textarea class="textarea-withBorder input-apremarks"></textarea>
									</td>
								</tr>
							</table>
						</td>
						<td class="tbl-vendor-detail-td4 tbl-vendor-detail-remarks">
							<table class="tbl-remarks">
								<tr>
									<th class="tbl-remarks-th1">F325 Remarks :</th>
									<td>
	...
	<div class="div-confirm">
		<div class="div-confirm-border">
			<h4 class="h4-header">Are you sure? This is Paid?</h4>
			<button type="button" class="button-confirm-style" onclick="Paid();">Yes</button>
