...
// update dbcompany
mysqli_query($conn,"UPDATE dbuser SET username='$username',password='$password',fname='$fname',admin='$admin',semiadmin='$semiadmin',comp1='$comp1',comp2='$comp2',comp3='$comp3',comp4='$comp4',comp5='$comp5',comp6='$comp6',comp7='$comp7',comp8='$comp8',comp9='$comp9',comp10='$comp10',loc1='$loc1',loc2='$loc2',loc3='$loc3',loc4='$loc4',loc5='$loc5',loc6='$loc6',loc7='$loc7',loc8='$loc8',loc9='$loc9',loc10='$loc10',store='$store',inventory='$inventory',import='$import',importdop='$importdop',print='$print',schedule='$schedule',clearing='$clearing',manual='$manual',fordeduct='$fordeduct',borfapps='$borfapps',dmpiraw='$dmpiraw',deduction='$deduction',deductdoc='$deductdoc',paiddeduction='$paiddeduction',payment='$payment',returntosupplier='$rts',pulloutdoc='$pulloutdoc',report='$report',syssetting='$system',active='$active' WHERE id='$id' ");
