...
<body>
	<table class="tbl-border">
		...
		<tr>
			<td class="tbl-border-td2" colspan="2">
				...
				<input type="text" class="input-withBorder input-search" onkeyup="LoadList();" placeholder="F325 Number..." value="">
				...
				<label class="lbl-style">Cluster:</label>
				<select class="select-withBorder select-cluster" onchange="LoadList();">
					<option value="">All</option>
					<?php
					$cluster_query = mysqli_query($conn,"SELECT * FROM dbcensus WHERE status='1' GROUP BY cluster ORDER BY cluster ASC ");
					while ($fetch_cluster = mysqli_fetch_array($cluster_query))
					{
						?>
						<option value="<?php echo $fetch_cluster['cluster']; ?>"><?php echo $fetch_cluster['cluster']; ?></option>
						<?php
					}
					?>
				</select>
				<button type="button" class="button-importexport button-import-csv">Import SCHEDULED</button>
				<button type="button" class="button-importexport button-export-csv">Export PRINTED</button>
				<input type="file" class="input-import-csv" accept=".csv">
			</td>
		</tr>
		<tr>
	...
	<div class="div-import-bg">
		<form class="form-import" onsubmit="return UpdateDetail();">
			<table class="tbl-form-import">
				<tr>
					<td class="tbl-form-import-td1">
						<button class="button-withBorder button-import-save">Import</button>
						<button type="button" class="button-withBorder button-import-discard">Discard</button>
					</td>
				</tr>
				<tr>
					<td class="tbl-form-import-td2">
						<div class="div-scroll-import">
							<table class="tbl-import-raw">
								<tr>
									<th class="tbl-import-raw-th1">F325 Number</th>
									<th class="tbl-import-raw-th2">BR Code</th>
									<th class="tbl-import-raw-th3">TM #</th>
									<th class="tbl-import-raw-th4">Driver Name</th>
									<th class="tbl-import-raw-th5">Plate #</th>
									<th class="tbl-import-raw-th6">Date Sched</th>
									<th class="tbl-import-raw-th7">Remarks</th>
									<th class="tbl-import-raw-th8">Status</th>
									<th class="tbl-import-raw-th9"></th>
								</tr>
								<tbody class="tbody-import-raw"></tbody>
							</table>
						</div>
					</td>
				</tr>
				...
				<table class="tbl-form-detail">
					<tr>
						<td class="tbl-form-detail-td1" colspan="4">
							...
							<button type="button" class="button-withBorder button-form-menu button-schedule" onclick="UpdateStatus();">Scheduled</button>
						...
						<td class="tbl-form-detail-td2" colspan="4">
							<table class="tbl-vendor-detail">
								<tr>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-tmnumber" onkeyup="CheckTMDriver();">
									</td>
								...
								<tr>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-driver" onkeyup="CheckTMDriver();">
									</td>
								...
								<tr>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-platenumber" onkeyup="CheckTMDriver();">
									</td>
									<th class="tbl-vendor-detail-th1">Date Sched:</th>
									<td class="tbl-vendor-detail-td1">
										<input type="date" class="input-withBorder input-datesched" value="<?php echo date('Y-m-d'); ?>">
									</td>
								</tr>
							</table>
