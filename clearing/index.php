...
<body>
	...
	<div class="div-bg">
		<div class="div-form">
			<form class="form-order-detail" onsubmit="return UpdateStatus();">
				<table class="tbl-form-detail">
					<tr>
						<td class="tbl-form-detail-td1" colspan="4">
							...
							<button type="button" class="button-withBorder button-form-menu button-reschedule">Re-Schedule</button>
							<button type="button" class="button-withBorder button-form-menu button-disposed">Disposed</button>
							<button class="button-withBorder button-form-menu button-received">Cleared</button>
							<button class="button-withBorder button-form-menu button-forpayment">For Payment</button>
							...
							<table class="tbl-vendor-detail">
								<tr>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-customer" brcode="" disabled="disabled">
									</td>
									...
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-arnumber" onkeyup="ShowForPayment();">
									</td>
								</tr>
								<tr>
									...
									<th class="tbl-vendor-detail-th1 file-upload">F325 Upload:</th>
									<td class="tbl-vendor-detail-td1 file-upload">
										<input type="file" class="input-withBorder file-upload input-f325file" accept=".jpeg,.jpg,.png">
										<button type="button" class="button-withBorder button-view-f325-doc">View F325 Doc.</button>
									</td>
								</tr>
								<tr>
									...
									<th class="tbl-vendor-detail-th1">Location:</th>
									<td class="tbl-vendor-detail-td1">
										<input type="text" class="input-withBorder input-location" deducttype="" disabled="disabled">
									</td>
								</tr>
							</table>
						...
						<td class="tbl-form-detail-td3" colspan="4">
							<div class="div-scroll div-scroll-raw">
								<table class="tbl-order-detail">
									<tr>
										<th class="tbl-order-detail-th12"></th>
										...
										<th class="tbl-order-detail-th8">DMPI Reason</th>
										<th class="tbl-order-detail-th4">Reason Code</th>
										<th class="tbl-order-detail-th5">Quantity</th>
										<th class="tbl-order-detail-th6">Rcvd QTY</th>
										<th class="tbl-order-detail-th7">Variance</th>
										<th class="tbl-order-detail-th13">Unit Cost</th>
										<th class="tbl-order-detail-th14">Cost Ext.</th>
										<th class="tbl-order-detail-th10">AR Reason</th>
										<th class="tbl-order-detail-th11">P. Status</th>
									</tr>
									<tbody class="tbl-order-list"></tbody>
									<tr class="tbl-order-detail-tr-button">
										<td class="tbl-order-detail-td-add" colspan="2">
											<button type="button" class="button-withBorder button-add-prd">Add</button>
										</td>
									</tr>
								</table>
							</div>
					...
					<tr>
						<td class="tbl-vendor-detail-td4 tbl-vendor-detail-scanner">
							<table class="tbl-scanner" style="display: none;">
								<tr>
									<th class="tbl-scanner-th1">Scan Item</th>
								</tr>
								<tr>
									<td class="tbl-scanner-td1">
										<input type="text" class="input-withBorder input-scanner">
									</td>
								</tr>
							</table>
						</td>
						...
						<td class="tbl-vendor-detail-td4 tbl-vendor-detail-subtotal">
							<table class="tbl-subtotal">
								<tr>
									<th class="tbl-subtotal-th1">Total Sub-total :</th>
									<td class="tbl-subtotal-td1">
										<input type="text" class="input-withBorder input-costextended-subtotal" disabled="disabled">
									</td>
								</tr>
								<tr>
									<th class="tbl-subtotal-th1">Total Qty :</th>
									<td class="tbl-subtotal-td1">
										<input type="text" class="input-withBorder input-totalqty" disabled="disabled">
									</td>
								</tr>
								<tr>
									<th class="tbl-subtotal-th1">Total Rcvd Qty :</th>
									<td class="tbl-subtotal-td1">
										<input type="text" class="input-withBorder input-totalrcvdqty" disabled="disabled">
									</td>
								</tr>
							</table>
						</td>
	...
	<!-- view photo doc -->
	<div class="div-photo-bg">
		<div class="div-photo-border">
			<button type="button" class="button-photo-close" title="Close">X</button>
