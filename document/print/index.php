...
$reference_query = mysqli_query($conn,"SELECT * FROM dbfordeduction WHERE reference='$reference' ");
...
<head>
	...
	<title>Print Deduct Summary</title>
...
<body>
	...
	<table class="tbl-border">
		<tr>
			<th class="tbl-border-th">DEDUCT SUMMARY</th>
		</tr>
		<tr>
		...
		<tr>
			<td class="tbl-border-td2">
				<table class="tbl-sku">
					<tr>
						<th class="tbl-sku-th tbl-sku-th1">Month</th>
						<th class="tbl-sku-th tbl-sku-th2">BR Code</th>
						<th class="tbl-sku-th tbl-sku-th3">Branch Name</th>
						<th class="tbl-sku-th tbl-sku-th4">Region</th>
						<th class="tbl-sku-th tbl-sku-th5">F325 Number</th>
						<th class="tbl-sku-th tbl-sku-th6">MDC Code</th>
						<th class="tbl-sku-th tbl-sku-th7">Description</th>
						<th class="tbl-sku-th tbl-sku-th8">BBD</th>
						<th class="tbl-sku-th tbl-sku-th9">Reason Code</th>
						<th class="tbl-sku-th tbl-sku-th10">Quantity</th>
						<th class="tbl-sku-th tbl-sku-th11">UoM</th>
						<th class="tbl-sku-th tbl-sku-th12">Cost Extended</th>
					</tr>
